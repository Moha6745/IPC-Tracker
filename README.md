...
| المقياس | التعريف |
|---|---|
| متوسط مدة الإنجاز | من أول مرحلة إلى أول «تسجيل باعتماد» — للمعتمدة فقط |
| متوسط الركود الحالي | من آخر مرحلة مسجّلة إلى اليوم — لغير المعتمدة، ولا يقل عن صفر لو سُجِّل تاريخ مستقبلي |
